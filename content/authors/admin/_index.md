...
Mohammad Hassan Vali is a Postdoctoral Researcher at the Department of Computer Science at Aalto University, Finland. His postdoctoral research is supervised by Prof. Arno Solin, and funded by Finnish Center of Artifical Intelliggence (FCAI). His research is mainly focused on discrete representation learning in deep neural networks. More specifically, his research explores more efficient vector quantization tecniques that find applications in image and speech processing downstream applicaitons such as image compression and generation, 3D Gaussin splatting compression, interpretable AI, speaker anonymization, and voice conversion.
